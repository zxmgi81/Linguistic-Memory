...
public class EntriesDemo {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            memory_window.User test1 = new memory_window.User("test1");
            ...
            memory_window.User test2 = new memory_window.User("test2");
            test2.setHardScore("15:15");
            test2.saveToFile();
            test2.setEasyScore("04:15");
            test2.saveToFile();
             
            memory_window.User test3 = new memory_window.User("test1");
