...
static JLabel Zeit = new JLabel("00:00"); //Jlabel for the stoppwatch
  ...
  while (true) {
   if (start) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println(isPair("DT","all"));
        
        //Stoppuhr and solvedPair frame
        ground.add(Zeit);
        ground.add(solvedPairs);
        back.add(ground);
        back.pack();
        back.setDefaultCloseOperation(EXIT_ON_CLOSE);
        back.setVisible(true); 
        
        //action event: start timer
